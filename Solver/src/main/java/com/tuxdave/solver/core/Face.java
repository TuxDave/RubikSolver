...
public class Face {
     ...
     * 
     * @param _border u/d/r/l
     * @param colors  int array containing the colors from high to low or from left
     *                to right
     */
    ...
    /**
     * the positions are like this: 1 2 3 8 0 4 7 6 5 to make easier the movements
    ...
    /**
     * set the color to one spot of the face the positions are like this: 1 2 3 8 0
     * 4 7 6 5 to make easier the movements so if you want to set the north-easth
     * spot put 3
     * 
     * @param _pos      the number of the interested spot
     * @param _newColor the color from 0 to 5 (you can use the converter static
     *                  method fromColorToInt)
     */
